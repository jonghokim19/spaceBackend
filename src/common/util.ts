...
export const external = <T>(param: AxiosRequestConfig<any>, service: ExternalService = ExternalService.DBMleverage, req?: Request, retryCount = 1): Promise<APIResponse<T>> => {
    ...
    return new Promise((resolve, reject) => {
        ...
        Promise.resolve()
            .then(() => {
                ...
                if (service === ExternalService.DBMleverage) {
