...
import UserController from './src/controller/adminController/UserController'
...
const launch = (): express.Express => {
    ...
    app.use(cors({
        origin: ['https://spacedesignx.com', 'http://localhost'], // 허용된 도메인
        methods: ['GET', 'POST', 'PUT', 'DELETE'], // 허용된 HTTP 메서드
...
let DBMleverage: express.Express | undefined = undefined;
